...
public:
    ...
    std::string_view get_method() const { return m_method; }

    std::string_view get_resource() const { return m_resource; }

    std::string_view get_protocol() const { return m_protocol; }
